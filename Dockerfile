...
&& apt-get -y install gcc postgresql libpq-dev wget $(apt-cache search libicu[0-9][0-9]|cut -d' ' -f 1) rsync libunwind-dev wget $(apt-cache search libssl1.0.[0-9]|cut -d' ' -f 1) \
